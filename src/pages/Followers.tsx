...
import { getProfileByUsername, getFollowersList, followUser, unfollowUser, isFollowing } from '../services/profileService'
    ...
    useEffect(() => {
        ...
        const load = async () => {
            try {
                ...
                const { data: followersData } = await getFollowersList(targetUserId)
