...
const Statistics: React.FC = () => {
    ...
    const statusData = useMemo(() => {
        return [
            { label: 'Completed', count: stats.totalCompleted, color: '#68ffae' },
            ...
            <div className="statistics-container">
                ...
                <div className="stats-grid stats-grid--2col">
                    <div className="stats-panel">
                        <h3 className="stats-panel__title">Completion Rate</h3>
                    ...
                    <div className="stats-panel">
                        <h3 className="stats-panel__title">Media Type Breakdown</h3>
                        <div className="stats-media">
                            <div className="stats-media__item">
                                <div className="stats-media__header"><span className="stats-media__label">Movies</span><span className="stats-media__count">{stats.totalMovies}</span></div>
                            ...
                            <div className="stats-media__item">
                                <div className="stats-media__header"><span className="stats-media__label">TV Shows</span><span className="stats-media__count">{stats.totalTvShows}</span></div>
                ...
                <div className="stats-grid stats-grid--2col">
                    <div className="stats-panel">
                        <h3 className="stats-panel__title">TMDB Score Distribution</h3>
                    ...
                    <div className="stats-panel">
                        <h3 className="stats-panel__title">Items Added Per Year</h3>
                ...
                <div className="stats-panel">
                    <h3 className="stats-panel__title">Insights</h3>
                    <div className="stats-insights">
                        <div className="stats-insight-card">
                            <div className="stats-insight-card__content">
                                ...
                                {stats.highestScored ? <>
                                    <div className="stats-insight-card__value">{stats.highestScored.vote_average}</div>
                        ...
                        <div className="stats-insight-card">
                            <div className="stats-insight-card__content">
                                ...
                                {stats.lowestScored ? <>
                                    <div className="stats-insight-card__value">{stats.lowestScored.vote_average}</div>
